# --
# Kernel/Modules/AdminDynamicFieldOTRSAgents.pm - provides a dynamic fields text config view for admins
...
package Kernel::Modules::AdminDynamicFieldOTRSAgents;
...
sub _ShowScreen {
    ...
    $Output .= $LayoutObject->Output(
        TemplateFile => 'AdminDynamicFieldOTRSAgents',
        Data         => {
            %Param,
